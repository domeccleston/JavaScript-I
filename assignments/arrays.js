...
console.log(`Car 33 is a ${inventory[34].car_year} ${inventory[34].car_make} ${inventory[34].car_model}`);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCarIndex = inventory.length - 1;
console.log("last car in inventory is a " + inventory[lastCarIndex].car_make + " " + inventory[lastCarIndex].car_model);
...
/* let oldCars = [];
  ...
  carYears[i] < 2000 ? oldCars.push(carYears[i]) : 0;
} */
...
/* let BMWAndAudi = [];
 ...
 let BMWAndAudi = inventory.filter(car => inventory[car].car_make === 'BMW' || inventory[car].car_make === 'Audi');
